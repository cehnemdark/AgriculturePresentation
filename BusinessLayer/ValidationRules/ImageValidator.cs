...
namespace BusinessLayer.ValidationRules
{
    public class ImageValidator : AbstractValidator<Image>
    {
        public ImageValidator()
        {
            ...
            RuleFor(x => x.Title).MaximumLength(25).WithMessage("Lütfen en fazla 25 karakter veri girişi yapın");
            RuleFor(x => x.Title).MinimumLength(8).WithMessage("Lütfen en fazla 8 karakter veri girişi yapın");
            RuleFor(x => x.Description).MaximumLength(50).WithMessage("Lütfen en fazla 50 karakter veri girişi yapın");
            RuleFor(x => x.Description).MinimumLength(20).WithMessage("Lütfen en fazla 20 karakter veri girişi yapın");
